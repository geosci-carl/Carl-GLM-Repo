...
build = False # build a master array data structure? (could take 20-30 minutes or more)
...
load = True # load in our master data arrays? (should take 1-2 minutes)
if (load):
...
#%% Let's grab annual precip data from each location for all 42 years (1980 - 2021)
